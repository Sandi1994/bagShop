package lk.sanchana_bag_shop.asset.purchase_order.controller;


import lk.sanchana_bag_shop.asset.common_asset.service.CommonService;
...
import lk.sanchana_bag_shop.asset.purchase_order.entity.enums.PurchaseOrderPriority;
import lk.sanchana_bag_shop.asset.purchase_order.entity.enums.PurchaseOrderStatus;
import lk.sanchana_bag_shop.asset.purchase_order.service.PurchaseOrderService;
...
import lk.sanchana_bag_shop.asset.supplier.service.SupplierService;
import lk.sanchana_bag_shop.asset.supplier_item.controller.SupplierItemController;
    ...
    public String purchaseOrderPersist(@Valid @ModelAttribute PurchaseOrder purchaseOrder,
        ...
        if (purchaseOrder.getId() == null) {
            if (purchaseOrderService.lastPurchaseOrder() == null) {
                ...
                purchaseOrder.setCode("SBPO" + makeAutoGenerateNumberService.numberAutoGen(null).toString());
            } else {

                //if there is customer in db need to get that customer's code and increase its value
                String previousCode = purchaseOrderService.lastPurchaseOrder().getCode().substring(4);
                purchaseOrder.setCode("SBPO" + makeAutoGenerateNumberService.numberAutoGen(previousCode).toString());
            }
        }
