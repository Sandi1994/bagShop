package lk.sanchana_bag_shop.asset.supplier.controller;
...
public  class SupplierController implements AbstractController< Supplier, Integer> {
    ...
    public String persist(@Valid @ModelAttribute Supplier supplier, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if(supplier.getId() ==null){
            Supplier supplierDb = supplierService.findByBrn(supplier.getBrn());
            if(supplierDb!= null){
                ObjectError error = new ObjectError("employee",
                                                    "There BRN is already in the system. <br>System message -->" );
        ...
        if (supplier.getId() == null) {
            ...
            if (DBSupplier == null) {
                ...
                supplier.setCode("SBSS"+makeAutoGenerateNumberService.numberAutoGen(null).toString());
            } else {
                ...
                supplier.setCode("SBSS"+makeAutoGenerateNumberService.numberAutoGen(previousCode).toString());
            }
