package lk.sanchana_bag_shop.asset.supplier.service;

import lk.sanchana_bag_shop.asset.common_asset.model.enums.LiveDead;
import lk.sanchana_bag_shop.asset.supplier.dao.SupplierDao;
...
public class SupplierService implements AbstractService<Supplier, Integer> {
  ...
  public Supplier findByBrn(String brn) {
        return supplierDao.findByBrn(brn);
  }
}
